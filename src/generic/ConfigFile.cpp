...
ConfigFile::ConfigFile(string filename, string filepath, string delimiter, string comment, string sectionStartTag,
                       string sectionEndTag, string sentry) :
    myDelimiter(delimiter), myComment(comment), mySectionStartTag(sectionStartTag), mySectionEndTag(sectionEndTag), mySentry(
        sentry)
{
...
ConfigFile::ConfigFile() :
    myDelimiter(string(1, '=')), myComment(string(1, '#')), mySectionStartTag(string(1, '[')), mySectionEndTag(
        string(1, ']'))
{
